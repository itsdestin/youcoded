...
| 2026-03-16 | 2.5 | Flip up/down arrows in TerminalKeyboardRow (← ↑ ↓ → order). Delete 7 dead code files from parser era: ApprovalCard, ProgressCard, CardState, MenuWidget, ConfirmationWidget, OAuthWidget, InputBar. Remove empty widgets/ directory | Cleanup | Destin | Quick wins |
