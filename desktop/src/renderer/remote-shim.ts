...
import type { RemoteBridge } from '../shared/types';
...
export function installShim(): void {
  ...
  (window as any).claude = {
    ...
    session: {
      ...
      // slice(-count) both need them). Guard: SessionBridge.loadHistory (shared/types.ts,
    ...
    // does — see SharedBridge in shared/types.ts.
