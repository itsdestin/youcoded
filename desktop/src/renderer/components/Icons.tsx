...
/** Settings gear — same path HeaderBar's SettingsGearButton draws, reused here
 *  (G-1: one glyph, one look) for any inline "open settings for this thing"
 *  control. Added for the plan card's "Plan settings" entry (decision 35). */
