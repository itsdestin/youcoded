  ...
  return (
    ...
    <>
      <Dialog
        ...
        scrollBody={false}
        className="p-5"
        // Marked once the preview image settles — never mid-spinner (the
        // publish-status placeholder above it is deliberately spinner-free).
        screen={previewLoading ? undefined : 'marketplace/theme-share'}
      >
