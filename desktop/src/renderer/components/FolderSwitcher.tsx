            ...
            <div ref={listRef} className="scroll-fade max-h-48 min-h-0">
              ...
              {folders.map((f) => {
                ...
                return (
                  ...
                  >
                    {/* Folder icon */}
                    <svg className={`w-3 h-3 shrink-0 ${f.exists ? 'text-fg-muted' : 'text-red-400/60'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z" />
                    </svg>
                    ...
                    {/* Stale warning */}
                    {!f.exists && (
                      <span className="text-4xs text-red-400/80 shrink-0" title="Directory not found">
                        missing
                      </span>
                    )}
