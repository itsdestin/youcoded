...
const PROTECTED: Protection[] = [
  ...
  { was: 'no-sync-fs-in-native-home-async-reads', file: 'native-home.ts',
    noBlocking: ['readSessionLinesAsync', 'listSessionFilesAsync', 'readSessionHeadAsync', 'readJsonAsync'],
    kinds: { readSessionLinesAsync: 'method', listSessionFilesAsync: 'method', readSessionHeadAsync: 'method', readJsonAsync: 'method' },
    why: 'every scroll-up page, tear-off, Resume list open and project-extensions:get; the sync twins stay legal for their sync callers' },
