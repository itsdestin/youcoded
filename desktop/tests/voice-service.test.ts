...
import {
  VoiceService,
  passDeadlineMs,
  type VoiceServiceToWorker,
  type VoiceWorkerHandle,
  type VoiceWorkerToService,
  type VoiceAssetsApi,
  SPEECH_RMS_FLOOR,
  SILENCE_STOP_MS,
...
// This section drives that same path: 100 ms slices, ten a second, exactly as the
// worklet produces them.
describe('the silence stop, driven by 100 ms loudness slices', () => {
  const INSTALLED = {
    voiceRoot: '/fake/voice',
    addonPath: '/fake/voice/runtime/package/sherpa-onnx.node',
    wrapperEntryPath: '/fake/voice/runtime/package/sherpa-onnx.js',
