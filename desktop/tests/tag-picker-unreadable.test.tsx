 ...
 *
 * WHY only the picker here: the Resume Browser half used to read ResumeBrowser.tsx as text;
 * it is now the ast-grep rule tag-empty-state-guarded-on-error (Plan B, 2026-09-16).
 */
